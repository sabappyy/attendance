...
async function login() {
    ...
    if (!employeeId) {
        status.innerHTML = "Employee ID is required.";
        return;
    }

    if (!password) {
        status.innerHTML = "Password is required.";
        return;
    }
    ...
    try {
        ...
        localStorage.setItem("employeeDepartment", result.employee.department);
        localStorage.setItem("employeeDesignation", result.employee.designation);
